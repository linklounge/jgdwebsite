...
import { messages } from "@/components/translate/languages";
            ...
            <div className="main-menu">
                ...
                <ul>
                    <li className="is-mega-menu">
                        <Link href="/">{translations.t('header.about')} <span className="sub-menu"></span></Link>
                    ...
                    {/* Página de Serviços */}
                    {/* <li className="is-mega-menu">
                        <Link href="/">Pages <span className="sub-menu"></span></Link>
                        <ul className="sub-menu">
                            <li>
                                <div className="mega-menu flex-content-c flex">
                                    <div className="mega-menu-item">
                    ...
                    <li className="is-mega-menu">
                        <Link href="/">{translations.t('header.services')} <span className="sub-menu"></span></Link>
                        {/* <ul className="sub-menu">
                            <li>
                                <div className="mega-menu flex-content-c flex">
                                    <div className="mega-menu-item">
                    ...
                    <li className="is-normal-menu">
                        <Link href="/">{translations.t('header.contact')} <span className="sub-menu"></span></Link>
                        {/* <ul className="sub-menu">
                            <li>
